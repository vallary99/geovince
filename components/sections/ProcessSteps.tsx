        ...
        <div className="relative mt-14">
          ...
          >
            {steps.map((s) => (
              <div
                key={s.step}
                className="group relative flex h-full flex-col bg-paper p-8 transition-colors duration-300 hover:bg-forest"
              >
                ...
                <p className="font-display mt-5 text-lg font-semibold uppercase transition-colors group-hover:text-paper">
                  {s.title}
                </p>
