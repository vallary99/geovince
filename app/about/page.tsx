      ...
      <section className="bg-forest text-paper">
        <Container className="py-20 md:py-28">
          ...
          <div className="mt-14 grid gap-8 lg:grid-cols-5 lg:items-stretch">
            <RevealGroup className="grid gap-8 sm:grid-cols-2 lg:col-span-3" stagger={0.08}>
            ...
            <Reveal delay={0.1} className="lg:col-span-2 min-h-[300px] sm:min-h-[360px] lg:min-h-0 overflow-hidden">
              <ParallaxImage strength={22} className="h-full w-full">
                <PhotoFrame image={images.guardStanding} caption="Trained personnel remain the foundation — verification makes them accountable" />
              </ParallaxImage>
            </Reveal>
          </div>
          <Reveal delay={0.15}>
        ...
        <Container className="py-20 md:py-28">
          ...
          <RevealGroup className="mt-10 grid gap-6 sm:grid-cols-2" stagger={0.07}>
            <div className="h-full border border-line p-7 transition-colors duration-300 hover:border-forest">
              <p className="font-display text-lg font-semibold uppercase">Leadership</p>
              <p className="mt-2 text-sm leading-relaxed text-ink/70">
                [LEADERSHIP / TEAM PROFILES TO BE PROVIDED]
              </p>
            </div>
            <div className="h-full border border-line p-7 transition-colors duration-300 hover:border-forest">
              <p className="font-display text-lg font-semibold uppercase">Licensing & certification</p>
              <p className="mt-2 text-sm leading-relaxed text-ink/70">
                [LICENSES, CERTIFICATIONS & ACCREDITATIONS TO BE PROVIDED]
              </p>
            </div>
            <div className="h-full border border-line p-7 transition-colors duration-300 hover:border-forest">
              <p className="font-display text-lg font-semibold uppercase">Case studies</p>
              <p className="mt-2 text-sm leading-relaxed text-ink/70">
            ...
            <div className="h-full border border-line p-7 transition-colors duration-300 hover:border-forest">
              <p className="font-display text-lg font-semibold uppercase">Company history</p>
              <p className="mt-2 text-sm leading-relaxed text-ink/70">
