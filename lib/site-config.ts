...
export const problem = {
  ...
  lead:
    "When was the last time you had absolute certainty your security team was exactly where they were supposed to be, doing exactly what they were paid to do?",
...
export const howItWorks = {
  ...
  lead:
    "Deploying the Geovince Smart Security System is a structured, seamless process. From day one, your site transitions from assumption-based security to verified, data-backed protection.",
...
export const onboarding = {
  ...
  lead:
    "We have designed our implementation process to minimise disruption, maximise confidence, and ensure that every client is fully operational and supported from day one.",
  stages: [
    {
      stage: "Stage 1",
...
export const services: Service[] = [
  ...
  },
  {
    ...
    summary:
      "Expert assessment of your current security posture, vulnerability mapping, and strategic recommendations for closing gaps before they become incidents.",
    body:
      "Expert assessment of your current security posture, vulnerability mapping, and strategic recommendations for closing gaps before they become incidents.",
  },
  {
    ...
    summary:
      "Standalone technology deployment for organisations with existing security teams who want to add the verification, transparency, and reporting power of the Geovince platform.",
    body:
      "Standalone technology deployment for organisations with existing security teams who want to add the verification, transparency, and reporting power of the Geovince platform.",
  },
];
...
export const pricingNote =
  "Custom pricing is developed based on site assessment, patrol requirements, and service scope. Contact us to receive a tailored proposal with full cost transparency.";
